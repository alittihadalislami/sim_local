        ...
        <div class="col-lg-10 mx-auto mb-5 p-5 elevation-2" style="background-color: white">
          <table class="table">
            ...
            <tr>
              ...
              <td>
                ...
                <td>:</td>
                <td style="font-size: 19px"><?= $at_tahun['semester'] == '2' ? 'Genap' : 'Ganjil' ?> / <?= $at_kelas ?></td>
            </tr>
          </table>
          ...
          <div class="teks" style="text-align: center">
            ...
            <div class="tanggal" style="margin-top: 20px">
              <div class="ar">شمبلونج، ٦  ذو القعدة  ١٤٤٠</div>
              <div class="id">Camplong, 9 Juli 2019</div>
            </div>
            ...
            <div class="ttd" style="text-align: center; margin-top: 20px">
              ...
              <div class="mudir" style="float: right;">
                ...
                <div class="nama" style="margin-top: 85px; font-weight: bold; font-size: 20px">Mughni Musa, Lc., M.Ag</div>
              </div>
            </div>
