		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td style="font-size: 14px; width: 28%"><?= $CI->tampilPredikat($id_santri, $id_kelas, $k, 'p') ?></td>

					<td><?= $dkn[$id_santri]['nilai'][$k]['k'] ?></td>
					<td><?= $CI->hitungPredikat($dkn[$id_santri]['nilai'][$k]['k'], 75)[0] ?></td>
					<td style="font-size: 14px;  width: 28%"><?= $CI->tampilPredikat($id_santri, $id_kelas, $k, 'k') ?></td>
				</tr>
				<?php endforeach ?>
			</tbody>
		</table>
			...
			<div class="kiri">
				...
				<table class="lebar">
					...
					<tr>
						...
						<td class="fon2" style="text-align:center"><?= $entry_wali['sakit'] ?> Hari</td>
					</tr>
					<tr>
						<td class="fon2">Idzin</td>
						<td class="fon2" style="text-align:center"><?= $entry_wali['ijin'] ?> Hari</td>
					</tr>
					<tr>
						<td class="fon2">Tanpa Keterangan</td>
						<td class="fon2" style="text-align:center"><?= $entry_wali['alpa'] ?> Hari</td>
					</tr>
				</table>
			</div>
			<div class="kanan">
